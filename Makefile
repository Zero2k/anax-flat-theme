...
# LESS and CSS
LESS 		 	= style.less style-light.less style-color.less style-dark.less style-colorful.less style-typography.less theme-one.less theme-two.less theme-three.less
